...
type ImgKeeperClient interface {
	...
	ImgList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ImgListRes, error)
}
...
func (c *imgKeeperClient) ImgList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ImgListRes, error) {
	out := new(ImgListRes)
	err := c.cc.Invoke(ctx, "/imgKeeper.ImgKeeper/ImgList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ImgKeeperServer interface {
	...
	ImgList(context.Context, *empty.Empty) (*ImgListRes, error)
...
func (UnimplementedImgKeeperServer) ImgList(context.Context, *empty.Empty) (*ImgListRes, error) {
...
func _ImgKeeper_ImgList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ImgKeeperServer).ImgList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/imgKeeper.ImgKeeper/ImgList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImgKeeperServer).ImgList(ctx, req.(*empty.Empty))
	}
